...
public class BinaryExpressionNode implements ASTNode {
    ...
    private Tuple<dev.yekllurt.interpreter.interpreter.scope.Data, dev.yekllurt.interpreter.interpreter.scope.Data> getNodeData(FunctionScope functionScope, VariableScope variableScope,
