 ...
 * - 30xxx method errors <br>
 * - 31xxx variable errors <br>
 */
public class SemanticError {

    // === Method errors ===
    public static final Error INVALID_METHOD_DEFINITION_TOO_MANY_PARAMETERS = new Error(30000, SemanticException.class,
            "Invalid method definition for the method '%s' as '%s' parameters are provided but only '%s' are allowed");

    public static final Error INVALID_METHOD_EXPECTED_RETURN_STATEMENT = new Error(30001, SemanticException.class,
            "Invalid method definition for the method '%s' as a return statement is expected but non is provided");

    public static final Error INVALID_METHOD_EXPECTED_NO_RETURN_STATEMENT = new Error(30002, SemanticException.class,
            "Invalid method definition for the method '%s' as no return statement is expected but one is provided");

    // === Variable errors ===
    public static final Error INVALID_VARIABLE_NOT_FOLLOWING_GUIDELINES = new Error(31000, SemanticException.class,
            "Invalid variable at token %s. The identifier '%s' doesn't follow the variable naming convention");

    public static final Error INVALID_VARIABLE_DECLARATION_NOT_FOLLOWING_GUIDELINES_CLASHES_WITH_SYSTEM_VARIABLE = new Error(31001, SemanticException.class,
    ...
    public static final Error INVALID_VARIABLE_ASSIGNMENT_CANT_OVERRIDE_SYSTEM_VARIABLES = new Error(31002, SemanticException.class,
